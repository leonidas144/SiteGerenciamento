...
<nav class="pcoded-navbar">
	...
	<div class="pcoded-inner-navbar main-menu">
			...
			<div class="main-menu-content">
				<ul>
					<li class="more-details"><a href="user-profile.html">
						<!--  <i class="ti-user"></i>View Profile</a> <a href="#!"> -->
						<i class="ti-settings"></i>Configurações</a> 
						<a href="<%=request.getContextPath()%>/ServletLogin2?acao=logout"><i class="ti-layout-sidebar-left"></i>Sair</a>
					</li>
				</ul>
			</div>
		</div>
			...
			<form class="form-material">
				<!--  <div class="form-group form-primary">
					<input type="text" name="footer-email" class="form-control"
						...
						class="float-label"><i class="fa fa-search m-r-10"></i>Search Friend</label>
				</div>-->
			</form>
		</div>
		...
		<ul class="pcoded-item pcoded-left-item">
			<li class="active"><a href="<%=request.getContextPath()%>/main/mainPage.jsp" class="waves-effect waves-dark"> <span class="pcoded-micon">
				<i class="ti-home"></i><b>D</b></span> <span class="pcoded-mtext" data-i18n="nav.dash.main">Início</span> 
			...
			<li class="pcoded-hasmenu"><a href="javascript:void(0)"
				...
				<ul class="pcoded-submenu">
					...
					<li class=" "><a href="<%=request.getContextPath()%>/main/usuario.jsp" class="waves-effect waves-dark"> 
						<span class="pcoded-micon"><i class="ti-angle-right"></i></span>
						<span class="pcoded-mtext" data-i18n="nav.basic-components.alert">Usuários</span>
						<span class="pcoded-mcaret"></span></a>
					</li>
					<li class=" "><a href="<%=request.getContextPath()%>/main/pesquisa.jsp" class="waves-effect waves-dark"> 
						<span class="pcoded-micon"><i class="ti-angle-right"></i></span> 
						<span class="pcoded-mtext" data-i18n="nav.basic-components.breadcrumbs">Pesquisa de usuários</span> 
						<span class="pcoded-mcaret"></span></a>
					</li>
					
					<li class=" "><a href="<%=request.getContextPath()%>/main/clientes.jsp" class="waves-effect waves-dark"> 
						<span class="pcoded-micon"><i class="ti-angle-right"></i></span> 
						<span class="pcoded-mtext" data-i18n="nav.basic-components.alert">Clientes</span>
						<span class="pcoded-mcaret"></span></a>
					</li>
					
					<li class=" "><a href="<%=request.getContextPath()%>/main/pesquisaClientes.jsp" class="waves-effect waves-dark">
						<span class="pcoded-micon"><i class="ti-angle-right"></i></span>
						<span class="pcoded-mtext" data-i18n="nav.basic-components.breadcrumbs">Pesquisa de clientes</span>
						<span class="pcoded-mcaret"></span></a>
					</li>
		...
		<ul class="pcoded-item pcoded-left-item">
			<li><a href="<%=request.getContextPath()%>/main/reluser.jsp"
				class="waves-effect waves-dark"> <span class="pcoded-micon"><i
