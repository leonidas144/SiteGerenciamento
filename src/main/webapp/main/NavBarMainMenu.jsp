			...
			<div class="main-menu-content">
				<ul>
					<li class="more-details"><a href="user-profile.html"><i
						...
						href="<%=request.getContextPath()%>/ServletLogin2?acao=logout"><i
		...
		<ul class="pcoded-item pcoded-left-item">
			...
			<li class="pcoded-hasmenu"><a href="javascript:void(0)"
				...
				<ul class="pcoded-submenu">
					...
					<li class=" "><a href="<%=request.getContextPath()%>/main/usuario.jsp"
						class="waves-effect waves-dark"> <span class="pcoded-micon"><i
					...
					<li class=" "><a href="<%=request.getContextPath()%>/main/pesquisa.jsp"
						class="waves-effect waves-dark"> <span class="pcoded-micon"><i
								class="ti-angle-right"></i></span> <span class="pcoded-mtext"
							data-i18n="nav.basic-components.breadcrumbs">Pesquisa de usuários</span> <span
							class="pcoded-mcaret"></span>
					</a></li>
